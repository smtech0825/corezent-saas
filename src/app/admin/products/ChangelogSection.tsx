        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-paper border border-rule rounded-card px-4 py-2.5 text-sm text-ink focus:outline-none focus:border-mark focus:ring-1 focus:ring-mark/20 transition-colors"
              />
            </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-2 border-t border-rule">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={saving}
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 text-sm font-semibold bg-mark hover:brightness-95 text-white px-5 py-3 sm:py-2.5 rounded-xl transition-colors disabled:opacity-50"
            >
