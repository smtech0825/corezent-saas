    ...
    <form onSubmit={handleSubmit} className="border border-rule bg-paper-raised rounded-card p-5 space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-mark text-white font-semibold text-sm px-5 py-3 sm:py-2.5 rounded-xl hover:brightness-95 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          <Send size={14} />
